...
growth_data <- data.frame(
  year = as.numeric(py_df$year),
  offender_profiles = as.numeric(py_df$offender_profiles),
  arrestee = as.numeric(py_df$arrestee),
  forensic_profiles = as.numeric(py_df$forensic_profiles),
  investigations_aided = as.numeric(py_df$investigations_aided),
  ndis_labs = as.numeric(py_df$ndis_labs),
  total_profiles = as.numeric(py_df$total_profiles)
) |>
